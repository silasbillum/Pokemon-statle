...
import ShowPokemonTeam from "../components/ShowPokemonTeam";
...
const LEADERBOARD_ENDPOINT = `${API_BASE_URL}/Leaderboard/top?limit=10`;
  ...
  const selectedPlayer = hoveredIndex !== null ? leaderboard[hoveredIndex] : null;
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,2fr)_minmax(320px,1fr)]">
                ...
                return (
                  <div
                    ...
                    className={`grid grid-cols-4 items-center py-3 px-2 rounded-md transition-colors duration-200 ${isTopThree
                      ...
                      } ${rank === 3 ? "text-orange-600 dark:text-orange-800 bg-orange-300 dark:bg-orange-300" : ""
                      }`}
                  >
          ...
          <ShowPokemonTeam player={selectedPlayer} />
        </div>
