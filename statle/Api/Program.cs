...
try
{
    ...
    try
    {
        ...
        Console.WriteLine("DEBUG: DbContext configured successfully.");
    }
    catch (Exception ex)
    {
        Console.WriteLine($"DEBUG: Error configuring DbContext: {ex.Message}");
    ...
    app.Use(async (context, next) =>
    {
        ...
        {
            Console.WriteLine($"DEBUG: An error occurred in the request pipeline: {ex.Message}");
            Console.WriteLine($"DEBUG: StackTrace: {ex.StackTrace}");
...
{
    Console.WriteLine($"DEBUG: An unhandled exception occurred during application startup: {ex.Message}");
    Console.WriteLine($"DEBUG: StackTrace: {ex.StackTrace}");
}